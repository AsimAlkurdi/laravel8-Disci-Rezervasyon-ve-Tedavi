...
<head>
    ...
    <link href="{{url('/')}}/assets/admin/assets/css/authentication/form-2.css" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/assets/admin/assets/css/forms/theme-checkbox-radio.css">
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/assets/admin/assets/css/forms/switches.css">
</head>
<body class="form">
...
<script src="{{url('/')}}/assets/admin/assets/js/authentication/form-2.js"></script>
